...
<div class="title">
	...
	<span class="byline">These are all accepted time change requests</span>
</div>
...
<table id="requestTable">
	...
	<tbody>
		<c:forEach items="${requests}" var="entry">
			<tr>
				<td><a title="View request" href="${pageContext.servletContext.contextPath}/auth/requests/view/${entry.id}"><img alt="View details" src="${pageContext.servletContext.contextPath}/resources/images/icons/ok24.png"></a></td>
