...
<div class="title">
	<h2>Rejected request list</h2>
	<span class="byline">These are all rejected time change requests</span>
</div>
...
<table id="requestTable">
	...
	<tbody>
		<c:forEach items="${requests}" var="entry">
			<tr>
				<td><a title="View request" href="${pageContext.servletContext.contextPath}/auth/requests/view/${entry.id}"><img alt="Details" src="${pageContext.servletContext.contextPath}/resources/images/icons/no24.png"></a></td>
