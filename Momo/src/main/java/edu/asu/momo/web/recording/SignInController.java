...
public class SignInController {
	...
	public String signOut(@ModelAttribute SignOutBackingBean signOut, Principal principle, RedirectAttributes attributes, Model model) {
		...
		attributes.addFlashAttribute("success_message", "You have succesfully clocked out.");
